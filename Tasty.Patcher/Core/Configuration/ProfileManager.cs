...
namespace Tasty.Patcher.Core.Configuration
{
    public class ProfileManager : ViewModelBase
    {
        ...
        /// </summary>
        public AppConfiguration Profile { get => activeProfile; }
        ...
        public ProfileManager(AppConfiguration activeProfile) : base()
        {
            this.activeProfile = activeProfile;
            ChangeActiveProfile(GetProfileByPath(activeProfile.FilePath));
        }
        ...
        private void Config_SettingsLoaded(object sender, EventArgs e)
        {
            if ((sender as AppConfiguration).ProfileName == Profile.ProfileName)
            {
        ...
        public bool ChangeActiveProfile(AppConfiguration newProfile)
        {
            ...
            try
            {
                ...
                Profile.SettingsRenamed -= Config_SettingsRenamed;
                Profile.SettingsLoaded -= Config_SettingsLoaded;
        ...
        public void CreateProfile(string name, string workingDir)
        {
            ...
            configuration.DefaultDirectory = workingDir;
            configuration.Save();
